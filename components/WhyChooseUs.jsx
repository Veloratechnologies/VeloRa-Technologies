          ...
          {cards.map((card, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="mt-auto rounded-md border border-white/20 bg-white/70 backdrop-blur-sm p-5 shadow-xl">

                  {/* Subtitle */}
                  <span className="text-[10px] font-bold uppercase tracking-[2px] text-blue-500 mb-2 block">
                    {card.subtitle}
                  </span>

                  {/* Title */}
                  <h3 className="text-xl font-bold text-grey mb-3">
                    {card.title}
                  </h3>
